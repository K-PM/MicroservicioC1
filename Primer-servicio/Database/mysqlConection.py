...
class OrderModel(Base):
    ...
    order_produc = relationship("Order_ProducModel", back_populates="order")
...
class Order_ProducModel(Base):
    ...
    order = relationship("OrderModel", uselist=False, back_populates="order_produc")
    ...
    def to_dict(self):
        return{
            ...
            'order_uuid': self.order.order_uuid if self.order else None
        }
